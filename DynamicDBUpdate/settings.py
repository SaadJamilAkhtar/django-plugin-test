"""
Django settings for DynamicDBUpdate project.
...
SECRET_KEY = 'django-insecure-+3)6o9dx^8(_ezf!cyn7tvq9ee%4un$8_l!jkm@k9dgp#64@yh'
...
ROOT_URLCONF = 'DynamicDBUpdate.urls'
...
WSGI_APPLICATION = 'DynamicDBUpdate.wsgi.application'
